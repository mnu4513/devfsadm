...
const ChattrCommand = () => {
    return (
        <div className='mx-4 my-4 lg:max-w-4xl lg:mx-auto'>
            ...
            <TerminalOutput content={`[root@localhost ~]# chattr +i file-1
[root@localhost ~]# chattr +a file-1
[root@localhost ~]#
`} />
...
`} />
            ...
            <TerminalOutput content={`[root@localhost ~]# chattr +a dir
[root@localhost ~]# touch dir/file
[root@localhost ~]# rm -rf dir/file
...
`} />
            ...
            <TerminalOutput content={`[root@localhost ~]# lsattr file-1
----i----------------- file-1
[root@localhost ~]#
`} />
