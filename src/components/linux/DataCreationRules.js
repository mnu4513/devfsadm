...
const DataCreationLinux = () => {
    return (
        <div className='mx-4 my-4 lg:max-w-4xl lg:mx-auto'>
            ...
            <Subheading text="1. Default Data" />
            ...
            <Subheading text="2. Customized Data" />
            ...
            <Subheading text="1. Personal Home Directory (Private Place)" />
            ...
            <Subheading text="2. Public Place" />
