...
const NetworkConfiguration = () => {
    return (
        <div className='mx-4 my-4 lg:max-w-4xl lg:mx-auto'>
            ...
            <Subheading text={`What is a Network?`} />
            ...
            <Subheading text={`What is Network Configuration?`} />
            ...
            <Subheading text={`Why Do We Need to Configure a Network in a Linux Machine?`} />
            ...
            <Text text={`1. Hub: A hub is a basic network device that connects multiple computers in a network. It operates in half-duplex mode and broadcasts data to all devices connected to it. However, it doesn't generate a MAC table and lacks intelligence in managing data traffic.`} />
            <Text text={`2. Switch: A switch is more advanced than a hub. It operates in full-duplex mode and generates a MAC table, allowing it to send data directly to the intended recipient device without broadcasting to all devices on the network.`} />
            ...
            <Text text={`1. Physical Address (MAC Address): This is a unique identifier assigned to the network interface card (NIC) of a device. It is used for communication within a local network.`} />
            <Text text={`2. Logical Address (IP Address): This is an identifier assigned to a device for communication over a network, such as the internet. IP addresses can be either IPv4 or IPv6.`} />
            ...
            <Text text={`1. IPv4: Consists of four blocks (octets), each 8 bits in size, represented in decimal format (e.g., 192.168.1.1).`} />
            <Text text={`2. IPv6: Consists of eight blocks, each 16 bits in size, represented in hexadecimal format (e.g., 2001:0db8:85a3:0000:0000:8a2e:0370:7334).`} />

            <Subheading text={`Types of IP Addresses`} />
            <Text text={`IP addresses can be categorized into two types:`} />
            <Text text={`1. Public IP: Unique across the internet, used for devices that need to be accessible from outside the local network.`} />
            <Text text={`2. Private IP: Used within a private network, not routable on the internet, meant for internal communication.`} />
            ...
            <Text text={`1. Automatically (using DHCP protocol): Devices receive an IP address automatically from a DHCP server.`} />
            <Text text={`2. Manual Configuration (by admin): An administrator manually assigns a static IP address and other network settings.`} />
