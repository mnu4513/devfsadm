...
const InstallAndSetup = () => (
  <div className='flex flex-col px-5 space-y-5 lg:max-w-6xl mx-auto mb-5'>
    ...
    <div>
      <p className='mt-2 ml-2'> While installing VMware pro 17 or higher version of VMware pro user key for pro version <span className='font-bold' >'MC60H-DWHD5-H80U9-6V85M-8280D'</span> </p>
