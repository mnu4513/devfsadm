  ...
  return (
    <div className='flex flex-col px-5 space-y-5 lg:max-w-6xl mx-auto mb-5'>
      ...
      <div className='ml-5'>
        ...
        <p className='mt-2 ml-4'>Download links of all tools are provided already. </p>
        <p className='mt-2 ml-4'> After the Installation of VMware, open VMware and start the setup. If you are having any issue in setup, you can refer the video for setup and isntallation.</p>
      </div>
      <div >
      ...
      <div>
        <p className='mt-2 ml-4'> While installing VMware pro 17 or higher version of VMware pro user key for pro version 'MC60H-DWHD5-H80U9-6V85M-8280D' </p>
