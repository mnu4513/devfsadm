...
const IntroToSolaris = () => {
  ...
  return (
    <div className='mx-4 my-4 lg:max-w-7xl lg:mx-auto'>
      <div>
        <h2 className='text-2xl font-bold mt-4 ml-4 mb-3'>Solaris</h2>
      ...
      <div className='mt-5 ml-4'>
        ...
        <span className=' ml-2 font-bold '>1. Scalability </span>
        ...
        <span className=' ml-2 font-bold '>2. Reliability </span>
        <p className='ml-7 mb-4'>
        ...
        <span className='font-bold mt-2 ml-2'>3. Security </span>
        <p className='ml-7 mb-4'>
        ...
        <span className='font-bold mt-2 ml-2'>4. Virtualization </span>
        <p className='ml-7 mb-4'>
        ...
        <span className='font-bold mt-2 ml-2'>5. File Systems </span>
        <p className='ml-7 mb-4'>
        ...
        <span className='font-bold mt-2 ml-2'>6. Networking </span>
        <p className='ml-7 mb-4'>
        ...
        <span className='font-bold mt-2 ml-2'>7. Compatibility </span>
        <p className='ml-7 mb-4'>
