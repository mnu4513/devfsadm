...
const FilesAndDir = () => {
  ...
  return (
    <div className='mx-4 my-4 lg:max-w-7xl lg:mx-auto'>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>1. To create an empty file</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>2. To create a size file</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>3. To create a text file in editor mode</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'> 4. To read a text file</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>5. To list down files</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>6. To list down files including hidden files</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>7. To list down all files with permission and size</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>8. To remove a file</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'> 9. To remove a file forcefully</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>10. To remove multiple files at a time </p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>11. To copy a file</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>12. To move a file</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>13. To rename a file</p>
...
<hr className='my-5 ml-4'/>
  ...
  <h2 className='ml-4 mr-2 mt-4 font-bold text-xl'> Directories </h2>
      <div className='ml-4'>
        <p className='mt-3 font-bold'>1. To create a directory</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>2. To create a children directory</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>3. To delete an empty directory</p>
      ...
      <div className='ml-4'>
        <p className='mt-3 font-bold'>4. To delete a non-empty directory</p>
