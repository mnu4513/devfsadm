...
const TermsOfServices = () => {
    return (
        <div className="container mx-auto mt-8 px-4 lg:max-w-7xl mb-5">
            ...
            <h2 className="text-xl font-semibold mb-2 mt-4">Acceptance of Terms</h2>
            ...
            <h2 className="text-xl font-semibold mb-2 mt-4">Description of Services</h2>
            ...
            <h2 className="text-xl font-semibold mb-2 mt-4">User Responsibilities</h2>
            ...
            <h2 className="text-xl font-semibold mb-2 mt-4">Course Content</h2>
            ...
            <h2 className="text-xl font-semibold mb-2 mt-4">User Conduct</h2>
            ...
            <h2 className="text-xl font-semibold mb-2 mt-4">Privacy</h2>

            <p className='mb-2'>
                We respect your privacy. Our <Link to="/privacy-policy" className='text-blue-400 mr-1'>
                    Privacy Policy
                </Link>
            ...
            <h2 className="text-xl font-semibold mb-2 mt-4">Termination of Services</h2>
            ...
            <h2 className="text-xl font-semibold mb-2 mt-4">Contact Information</h2>

            <p className='mb-2'>
                If you have any questions or concerns about these terms, please contact us at <a href="mailto:contact@devfsadm.com" className='text-blue-400'>contact@devfsadm.com</a>.
